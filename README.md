...
[![CI](https://github.com/praetorian-inc/redmap/actions/workflows/ci.yaml/badge.svg)](https://github.com/praetorian-inc/redmap/actions/workflows/ci.yaml)
[![Go Version](https://img.shields.io/github/go-mod/go-version/praetorian-inc/redmap)](go.mod)
[![License](https://img.shields.io/github/license/praetorian-inc/redmap)](LICENSE)
[![Go Report Card](https://goreportcard.com/badge/github.com/praetorian-inc/redmap)](https://goreportcard.com/report/github.com/praetorian-inc/redmap)
[![GitHub Release](https://img.shields.io/github/v/release/praetorian-inc/redmap?include_prereleases&sort=semver)](https://github.com/praetorian-inc/redmap/releases)
...
```bash
go install github.com/praetorian-inc/redmap/cmd/redmap@latest
```

Or build from source:

```bash
git clone https://github.com/praetorian-inc/redmap.git
cd redmap
